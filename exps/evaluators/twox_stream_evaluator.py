...
class TWOX_COCOEvaluator:
    ...
    def __init__(
            self, dataloader, img_size, confthre, nmsthre, num_classes, testdev=False, per_class_mAP=True,
    ):
        """
        Args:
        ...
        for (output, img_h, img_w, img_id) in zip(
            ...
            for ind in range(bboxes.shape[0]):
                ...
                if img_id_int >= len(images) - 2:
                    ...
                    continue
                elif images[img_id_int + 2]['fid'] == 0:
                    continue

                elif images[img_id_int]['fid'] == 0:
                    idd = img_id_int
                elif images[img_id_int]['fid'] == 1:
                    idd = img_id_int + 1
                else:
                    idd = img_id_int + 2
